...
<head>
    ...
    <title>RGPD WEB - Autrement plus simple</title>
    <!-- Loading Bootstrap -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7 padding-top-40">
                    ...
                    <h3>
                        <font color="white">RGPD WEB - Autrement plus simple</font>
                    </h3>

                    <p>Découvrez notre solution innovante clé en main pour la gestion de toute votre conformité RGPD !</p>

                    <ul class="home-benefits">

                        <li><i class="fas fa-check-circle"></i>Sérénité, sécurité et gain de temps</li>

                          <li><i class="fas fa-check-circle"></i>Compétence & réactivité à votre écoute</li>

                          <li><i class="fas fa-check-circle"></i>Coût minimun pour un maximum de services</li>


<br />


          <video id='my-video' class='video-js' controls preload='auto' width='530' height='270'
  poster='video2.png' data-setup='{}'>
    <source src='rgpd.mp4' type='video/mp4'>
    <p class='vjs-no-js'>
      ...
      <a href='https://videojs.com/html5-video-support/' target='_blank'>supports HTML5 video</a>
                    ...
                    <div class="register-form-wrapper wow bounceIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;">
                        ...
                        <div>
                            ...
                            <form onsubmit="validate_form();return false" id="register-form" class="register-form register">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 has-feedback" style="padding-right:0;margin-bottom:7px">
                                        <input id="id_firstname" class="register-input white-input" placeholder="Prénom" required />
                                             ...
                                             <div class="col-lg-6 has-feedback" style="padding-right:0;margin-bottom:7px">
                                        <input id="id_firstname" class="register-input white-input" placeholder="Nom de l'entreprise" required />

                                    </div>


                                             <div class="col-lg-6 has-feedback" style="padding-right:0;margin-bottom:7px">
                                        <input id="id_firstname" class="register-input white-input" placeholder="Téléphone" required />
                                ...
                                <input id="id_send_data" value="Envoyer votre demande &gt;" class="register-submit" type="submit">
                ...
                <br />
<p>
    <img src="logo-ord.png" alt="" style="float:left; padding-right:20px;">
<small><b>Un partenariat à échelle nationale !</b><br />
En 2019, RGPD Web devient partenaire du Conseil supérieur de l’Ordre des Experts-Comptables.<br />
</small>
</p>
